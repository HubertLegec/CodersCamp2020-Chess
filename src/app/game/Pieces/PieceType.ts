export enum PieceType {
    White_Pawn = '<img class="white" src="./img/pieces/Pawn.svg">',
    White_King = '<img class="white" src="./img/pieces/King.svg">',
    White_Queen = '<img class="white" src="./img/pieces/Queen.svg">',
    White_Rook = '<img class="white" src="./img/pieces/Rook.svg">',
    White_Bishop = '<img class="white" src="./img/pieces/Bishop.svg">',
    ...
    Black_Knight = '<img class="black" src="./img/pieces/Knight.svg">',
}